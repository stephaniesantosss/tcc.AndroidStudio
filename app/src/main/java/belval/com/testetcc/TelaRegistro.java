...
public class TelaRegistro extends AppCompatActivity {
    ...
    RadioGroup BIJ;
    RadioButton  Barueri, Itapevi, Jandira;
    EditText Nome, CPF, EMail, Cartao, DataNasc, Senha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BIJ = findViewById(R.id.rdgBIJ);
        Nome = findViewById(R.id.edtNome);
        DataNasc = findViewById(R.id.DataNascim);
        Cartao = findViewById(R.id.edtCpf);
        Barueri = findViewById(R.id.rdBarueri);
        Itapevi = findViewById(R.id.rdItapevi);
        Jandira = findViewById(R.id.rdJandira);
        CPF = findViewById(R.id.edtCPF);
        botaoRegistro = findViewById(R.id.btnEnviar);
        ...
        DataNasc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        TelaRegistro.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        BIJ.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (Barueri.isChecked() == true) {
                    Metodos.alert("Barueri selecionado", getApplicationContext());
                } else if (Itapevi.isChecked() == true) {
                    Metodos.alert("Itapevi selecionado", getApplicationContext());
                } else if (Jandira.isChecked() == true) {
                    Metodos.alert("Jandira selecionado", getApplicationContext());
                }
            }
        });
        ...
        botaoRegistro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Metodos.isCPF(CPF.getText().toString())) {

                } else if (cpf == null || cpf.equals("")) {
                    CPF.setError("Este campo é obrigatório");

                } else {
                    CPF.setError("CPF inválido, verifique");
                }

                String email = EMail.getText().toString();
                if (Metodos.validateEmail(EMail.getText().toString())) {

                } else if (email == null || email.equals("")) {
                    EMail.setError("Este campo é obrigatório");

                } else {
                    EMail.setError("Email inválido, verifique");
                }
                ...
                if (senha == null || senha.equals("")) {
                    ...
                    Senha.setError("Senha deve conter no mínimo 6 caracteres");
                ...
                if (nome == null || nome.equals("")) {
                    ...
                    Cartao.setError("Este campo é obrigatório");
                    DataNasc.setError("Este campo é obrigatório");
